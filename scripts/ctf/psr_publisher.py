...
# from framework.performance.framework.harness import InjectorRpmHarness
from framework.performance.nwcore_devices_manager import PSRNwCoreDeviceManager
...
if __name__ == '__main__':
    ...
    decoder_nodes = config['servers']['decoder']['ip']
    ...
    p = PSRNwCoreDeviceManager()
    p.ResetNwDevices(p.concentrators)#  + p.decoders + p.log_decoders)
    p.Close()

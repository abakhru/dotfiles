...
certs_dir = '/Users/bakhra/src/scripts/ctf/ssl'
...
class RabbitMQBase(object):
    ...
    def __init__(self, host='localhost', port=5672
                 ...
                 , _type='headers', ssl=False, ssl_options=None,): #ssl_version='ssl.PROTOCOL_TLSv1_2'):
        ...
        # LOGGER.debug('ssl_options: %s' % ssl_options)
    ...
    def connect(self, binding={'esa.event.type':'Event'}
        ...
        # try:
            ...
            # LOGGER.debug('connParameters: %s' % self.connParameters)

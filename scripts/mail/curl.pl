...
/opt/csw/bin/curl -v --sslv3 --cert /opt/certs/newcerts/$user-KeyCert.pem --cacert /opt/certs/newcerts/cacert.pem -c /tmp/cookies.txt https://dianthos.sfbay.sun.com:81/iwc/svc/wabp/login.wabp

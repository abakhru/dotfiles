...
function os_packages_install() {
  ...
  if [ "$(uname -s)" = "Darwin" ]; then
    ...
    /opt/homebrew/bin/brew install npm zsh tmux git vim htop ruby node wget fzf maven openjdk awscli docker-compose go lazydocker cloudflared k9s docker-credential-helper docker-credential-helper-ecr kubecolor sniffnet
